...
public class BasePageTest {
	...
	@BeforeTest
	  public void beforeTest() throws Exception {
		...
		logger.info("page inititalize complete.");
	  }
...
//	@Test
//	public void soutuByPic(){
//		try {
//			//String path = OperateSettings.getDataPath()+"soutu/test_hua.jpg" ;
//			String path="C:\\Kira\\WorkSpace\\BaiduTest\\Test_data_Excels\\soutu\\test_hua.jpg";
//			pageInit.bPage.soutu_upload_pic(path);
//			
//			
//		} catch (Exception e) {
